...
List<int> canceledProductsIds=[];
  ...
  deleteProduct(int id){
     state.orderDetailsModel?.orderDetails?.removeWhere((element) => element.id==id);
  ...
  updateOrder(int id)async{
    ...
    final response = await OrderRepository.updateOrder(id,approvedProductsIds,canceledProductsIds);
    response.fold((l) {
