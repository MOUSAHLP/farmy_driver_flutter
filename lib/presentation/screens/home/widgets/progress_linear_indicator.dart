  ...
  Widget build(BuildContext context) {
    return  SizedBox(
      ...
      child: Container(
          ...
          child: Padding(
            padding:  const EdgeInsets.symmetric(horizontal: PaddingApp.p12,vertical:PaddingApp.p10 ),
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(AppLocalizations.of(context)!.accept_percent,style: getRegularStyle(color: ColorManager.grayForMessage,fontSize: FontSizeApp.s15),),
                Padding(
                    ...
                    children: [
                      const Expanded(
                        child: LinearProgressIndicator(
                          value: 0.9,
                          minHeight: 9,
                          borderRadius: BorderRadius.all(Radius.circular(RadiusApp.r18)),
                          backgroundColor: ColorManager.lightGray,
                          valueColor: AlwaysStoppedAnimation<Color>(ColorManager.primaryGreen),
                        ),
                      ),
                      const SizedBox(width: SizeApp.s10,),
                      Text('90 %',style: getBoldStyle(color: ColorManager.primaryGreen),),
                    ],
                  ),
                )
              ],
