                  ...
                  PositionedDirectional(
                    ...
                    child: Container(
                      ...
                      child: SlideAction(
                        ...
                        sliderButtonIcon: const Icon(Icons.double_arrow_outlined,color: ColorManager.primaryGreen,),
                        text: '${AppLocalizations.of(context)?.delivered}',
                        textStyle: getBold800Style(
                            color: ColorManager.white, fontSize: FontSizeApp.s15),
                        outerColor: cubit.isDelivery ? const Color(0xFFFF7E7E) : Colors.green,
                        sliderRotate: false,
                        borderRadius: 10,
                        onSubmit: () {
                          cubit.delivery();
                                                ...
                                                content: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    InkWell(
                                                      ...
                                                      child: CircularContainer(circular: 15,
                                                          text: "تم",
                                                          color: ColorManager.primaryGreen,
