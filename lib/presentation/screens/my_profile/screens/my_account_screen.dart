          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                Padding(
                  padding:  const EdgeInsetsDirectional.symmetric(horizontal: PaddingApp.p41),
                  child: Column(
                    children: [
                    const SizedBox(
                      height: 14,
                    ),
                    const ImageSvgWidget(url: IconsManager.crownIcon).buildAssetSvgImage(),
                    const SizedBox(
                      height: 4,
                    ),
                    Container(
                      ...
                      Text(AppLocalizations.of(context)!.edit_Picture,
                      ...
                      Align(
                        alignment:AlignmentDirectional.centerStart,
                        child: Text(AppLocalizations.of(context)!.personal_Details,
                          style: getBold800Style(
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            CustomButton(
                                label: AppLocalizations.of(context)!.change_Number,
                                onTap: () {
                                  showDialog(
                                    context: context,
